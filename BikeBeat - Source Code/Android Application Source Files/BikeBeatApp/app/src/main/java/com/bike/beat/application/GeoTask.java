...
/**
 * Created by deception on 1/9/2016.
 */
/*The instance of this class is called by "FuelcalActivty",to get the time taken reach the destination from Google Distance Matrix API in background.
  This class contains interface "Geo" to call the function setDouble(String) defined in "FuelcalActivity.class" to display the result.*/
